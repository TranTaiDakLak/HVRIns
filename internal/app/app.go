...
import (
	...
	// Register session-pool packages — giữ lại cho luồng IG iOS/WebAndroid
	// (runResources). KHÔNG còn platform FB sXXX nào được import sau cleanup.
...
func originalUABaseForPlatform(platform string) string {
	...
	case instagram.PlatformS399:
		return "Dalvik/2.1.0 (Linux; U; Android 15; SM-S911B Build/AP3A.240905.015.A2) [FBAN/FB4A;FBAV/399.0.0.24.93;FBPN/com.facebook.katana;FBLC/en_GB;FBBV/440587081;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBDV/SM-S911B;FBSV/15;FBLC/en_GB;FBOP/1;FBCA/arm64-v8a:armeabi-v7a;]"
	case instagram.PlatformS550V2:
