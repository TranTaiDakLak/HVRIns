// package s563v4s21 — Samsung Galaxy S21+ (SM-G996B) + FB API 563 account verification.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS563V4S21, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS563V4S21, RandomUA)
}
