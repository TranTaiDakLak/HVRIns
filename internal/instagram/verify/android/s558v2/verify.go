// package s558v2 — Samsung S23 + FB API 558 Facebook account verification.
...
// Verifier implements instagram.Verifier for S558V2 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS558V2, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS558V2, RandomUA)
}
