// package s564v1s21 — Samsung Galaxy S21+ (SM-G996B) + FB API 563 account verification.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS564V1S21, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS564V1S21, RandomUA)
}
