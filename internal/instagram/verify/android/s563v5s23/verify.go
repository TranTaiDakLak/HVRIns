// package s563v5s23 — Samsung Galaxy S23+ (SM-S911B) + FB API 563 account verification.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS563V5S23, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS563V5S23, RandomUA)
}
