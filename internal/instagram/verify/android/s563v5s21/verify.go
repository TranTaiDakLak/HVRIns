// package s563v5s21 — Samsung Galaxy S21+ (SM-G996B) + FB API 563 account verification.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS563V5S21, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS563V5S21, RandomUA)
}
