...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS561V2, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS561V2, RandomUA)
}
