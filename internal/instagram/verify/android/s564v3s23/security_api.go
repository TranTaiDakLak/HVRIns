...
// Toàn bộ logic chia sẻ ở package secapi. Constants build 564.0.0.48.74 (capture 2026-05).
package s564v3s23
...
// securitySpec — biến thể S564V1S21: docID build 564.0.0.48.74 mới, bloksVer giữ nguyên, metaZca = "empty_token".
var securitySpec = secapi.Spec{
	DocIDAddSubEmail:     secapi.DocIDAddSubEmailDefault,
	DocIDContactPoint:    "11994080422959257612163598103",
	DocIDConfirmSubEmail: "11994080422959257612163598103",
