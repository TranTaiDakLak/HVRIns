...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS562V4S23, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS562V4S23, RandomUA)
}
