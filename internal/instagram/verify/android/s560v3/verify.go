// package s560v3 — Samsung S23 + FB API 560 v3 Facebook account verification.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS560V3, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS560V3, RandomUA)
}
