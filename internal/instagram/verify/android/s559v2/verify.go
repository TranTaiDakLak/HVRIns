// package s559v2 — Samsung S23 + FB API 559 Facebook account verification.
...
// Verifier implements instagram.Verifier for S559 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS559V2, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS559V2, RandomUA)
}
