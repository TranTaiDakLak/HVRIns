// package s554v2 — Samsung S23 + FB API 455 Facebook account verification.
...
// Verifier implements instagram.Verifier for S554V2 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS554V2, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS554V2, RandomUA)
}
