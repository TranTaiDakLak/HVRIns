// package s553v2 — Samsung S23 + FB API 455 Facebook account verification.
...
// Verifier implements instagram.Verifier for S553V2 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS553V2, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS553V2, RandomUA)
}
