// package s556v2 — Samsung S23 + FB API 556 Facebook account verification.
...
// Verifier implements instagram.Verifier for S556V2 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS556V2, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS556V2, RandomUA)
}
