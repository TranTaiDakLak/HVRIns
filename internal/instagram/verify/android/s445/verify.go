// package s445 — Samsung S23 + FB API 445 Facebook account verification.
...
// Verifier implements instagram.Verifier for S445 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS445, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS445, RandomUA)
}
