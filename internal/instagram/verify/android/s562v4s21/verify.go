...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS562V4S21, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS562V4S21, RandomUA)
}
