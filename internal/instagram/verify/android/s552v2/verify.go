// package s552v2 — Samsung S23 + FB API 455 Facebook account verification.
...
// Verifier implements instagram.Verifier for S552V2 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS552V2, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS552V2, RandomUA)
}
