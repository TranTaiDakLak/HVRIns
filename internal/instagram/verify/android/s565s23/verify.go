...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS565S23, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS565S23, RandomUA)
}
