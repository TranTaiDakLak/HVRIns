// package s425 — Samsung S23 + FB API 425 Facebook account verification.
...
// Verifier implements instagram.Verifier for S425 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS425, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS425, RandomUA)
}
