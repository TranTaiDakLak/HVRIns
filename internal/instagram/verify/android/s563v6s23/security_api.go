...
// Toàn bộ logic chia sẻ ở package secapi. Constants build 563.1.0.50.73 (capture 2026-05).
package s563v6s23
...
// securitySpec — biến thể S563V4S21: docID build 563.1.0.50.73 mới, bloksVer giữ nguyên, metaZca = "empty_token".
var securitySpec = secapi.Spec{
	DocIDAddSubEmail:     secapi.DocIDAddSubEmailDefault,
	DocIDContactPoint:    "11994080426554467581667453023",
	DocIDConfirmSubEmail: "11994080426554467581667453023",
