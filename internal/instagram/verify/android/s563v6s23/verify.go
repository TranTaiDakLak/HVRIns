// package s563v6s23 — Samsung Galaxy S23+ (SM-S911B) + FB API 563 account verification.
...
// Verifier implements instagram.Verifier for S563V4S21 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS563V6S23, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS563V6S23, RandomUA)
}
