// package s455 — Samsung S23 + FB API 455 Facebook account verification.
...
// Verifier implements instagram.Verifier for S455 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS455, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS455, RandomUA)
}
