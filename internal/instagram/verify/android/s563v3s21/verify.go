// package s563v3s21 — Samsung Galaxy S21+ (SM-G996B) + FB API 563 account verification.
...
// Verifier implements instagram.Verifier for S563V3S21 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS563V3S21, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS563V3S21, RandomUA)
}
