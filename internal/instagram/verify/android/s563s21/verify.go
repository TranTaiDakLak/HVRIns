// package s563s21 — Samsung Galaxy S21+ (SM-G996B) + FB API 563 account verification.
...
// Verifier implements instagram.Verifier for S563S21 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS563S21, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS563S21, RandomUA)
}
