...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS565V2S21, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS565V2S21, RandomUA)
}
