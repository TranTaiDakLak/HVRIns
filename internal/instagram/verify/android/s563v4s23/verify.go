// package s563v4s23 — Samsung Galaxy S23 (SM-S911B) + FB API 563 account verification.
// Clone từ verify/s563v2 — cùng doc_id/bloks_ver build 563.0.0.0.26, FBBV/972941018.
// Khác s563v2: device trong UA builder = SM-S911B (density 3.0, 1080x2340).
...
// Verifier implements instagram.Verifier for S563V4S23 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS563V4S23, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS563V4S23, RandomUA)
}
