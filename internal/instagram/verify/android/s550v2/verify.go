// package s550v2 — Samsung S23 + FB API 455 Facebook account verification.
...
// Verifier implements instagram.Verifier for S550V2 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS550V2, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS550V2, RandomUA)
}
