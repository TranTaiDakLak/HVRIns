// package s557v2 — Samsung S23 + FB API 557 Facebook account verification.
...
// Verifier implements instagram.Verifier for S557V2 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS557V2, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS557V2, RandomUA)
}
