// package s562v3 — Samsung S23 + FB API 562v3 Facebook account verification.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS562V3, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS562V3, RandomUA)
}
