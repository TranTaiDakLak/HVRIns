// package s564v1s23 — Samsung Galaxy S23 (SM-S911B) + FB API 563 account verification.
...
// Verifier implements instagram.Verifier for S564V1S23 platform.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformS564V1S23, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformS564V1S23, RandomUA)
}
