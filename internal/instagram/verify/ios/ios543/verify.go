...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS543, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS543, RandomUA)
