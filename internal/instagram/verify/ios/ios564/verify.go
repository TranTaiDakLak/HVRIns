...
// Verifier implements instagram.Verifier cho platform iOS564.
type Verifier struct{}

// Verify thực hiện flow verify cho 1 account iOS564.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS564, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS564, RandomUA)
