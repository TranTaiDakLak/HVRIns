...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS538, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS538, RandomUA)
