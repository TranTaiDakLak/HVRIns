...
// Verifier implements instagram.Verifier cho platform iOS530.
type Verifier struct{}

// Verify thực hiện flow verify cho 1 account iOS530.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS531, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS531, RandomUA)
