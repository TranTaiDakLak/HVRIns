...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS437, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS437, RandomUA)
