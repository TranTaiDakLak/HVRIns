...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS546, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS546, RandomUA)
