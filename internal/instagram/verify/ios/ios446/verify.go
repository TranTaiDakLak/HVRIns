...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS446, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS446, RandomUA)
