...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS429, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS429, RandomUA)
