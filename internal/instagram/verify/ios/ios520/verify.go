...
// Verifier implements instagram.Verifier cho platform iOS520.
type Verifier struct{}

// Verify thực hiện flow verify cho 1 account iOS520.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS520, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS520, RandomUA)
