...
// Verifier implements instagram.Verifier cho platform iOS540.
type Verifier struct{}

// Verify thực hiện flow verify cho 1 account iOS540.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS541, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS541, RandomUA)
