...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS458, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS458, RandomUA)
