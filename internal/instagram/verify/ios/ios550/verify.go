...
// Verifier implements instagram.Verifier cho platform iOS550.
type Verifier struct{}

// Verify thực hiện flow verify cho 1 account iOS550.
...
func init() {
	instagram.RegisterPlatformVerifier(instagram.PlatformIOS550, func() instagram.Verifier {
		return &Verifier{}
	})
	instagram.RegisterPlatformVerifyUA(instagram.PlatformIOS550, RandomUA)
