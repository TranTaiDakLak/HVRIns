// body.go — S462 register POST body builder + app constants.
// FBAV/462.0.0.0.62, FBBV/597292699.
...
var S560AppVersions = []struct {
	...
	{"462.0.0.0.62", "597292699"}, // captured traffic — confirmed (May 2026)
}
...
const (
	...
	OriginalUA = "[FBAN/FB4A;FBAV/462.0.0.0.62;FBBV/597292699;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
