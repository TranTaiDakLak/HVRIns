...
const (
	...
	// OriginalUA â€” UA gá»‘c cá»‘ Ä‘á»‹nh cho platform s565v2s23 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/565.0.0.0.58;FBBV/986097483;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung S23 device variant (reused for s565)
...
func buildRegisterBody(profile S565S23Profile, encPassword, contactpoint, contactpointType, locale string) string {
...
func createAccountVariablesS565(profile S565S23Profile, encPassword, contactpoint, contactpointType string) string {
