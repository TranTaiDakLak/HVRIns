// body.go — S416 register POST body builder + app constants.
// FBAV/416.0.0.0.16, FBBV/477969279.
...
var S560AppVersions = []struct {
	...
	{"416.0.0.0.16", "477969279"}, // captured traffic — confirmed (May 2026)
}
...
const (
	...
	OriginalUA = "[FBAN/FB4A;FBAV/416.0.0.0.16;FBBV/477969279;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
