// body.go — s542 register POST body builder + app constants.
// FBAV/542.0.0.60.83, FBBV/839882771.
...
var s542AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"542.0.0.60.83", "839882771"}, // captured traffic — confirmed
}

const (
	s542DocID        = "119940804210382635615484396344"
	s542BloksVer     = "182a4e03087cc46a88a95c6e5747a622a0ab08e2134522bd0e6da65b9ceea9fd"
	s542OAuthToken   = "350685531728|62f8ce9f74b12f84c123cc23437a4a32"
	s542MetaZCA      = "empty_token"
	s542FriendlyName = "FbBloksActionRootQuery-com.bloks.www.bloks.caa.reg.create.account.async"
	s542StylesID     = "fefbd1d6b452bcac026b965ec70e37ee"

	// OriginalUA — UA gốc cố định cho platform s542 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/542.0.0.60.83;FBBV/839882771;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung S23 device variant (reused for s542)
...
// buildRegisterBody sinh form-urlencoded body cho s542 reg.create.account.async.
func buildRegisterBody(profile s542Profile, encPassword, contactpoint, contactpointType, locale string) string {
	variables := createAccountVariabless542(profile, encPassword, contactpoint, contactpointType)
	...
	parts := []string{
		...
		"locale=" + locale,
		"purpose=fetch",
		"fb_api_req_friendly_name=" + s542FriendlyName,
		"fb_api_caller_class=graphservice",
		"client_doc_id=" + s542DocID,
...
func createAccountVariabless542(profile s542Profile, encPassword, contactpoint, contactpointType string) string {
	...
	return "%7B%22params%22%3A%7B%22params%22%3A%22%7B%5C%22params%5C%22%3A%5C%22%7B" +
		...
		"%5C%22%7D%22%2C%22bloks_versioning_id%22%3A%22" + s542BloksVer + "%22%2C%22app_id%22%3A%22com.bloks.www.bloks.caa.reg.create.account.async%22%7D%2C%22scale%22%3A%223%22%2C%22nt_context%22%3A%7B%22using_white_navbar%22%3Atrue%2C%22styles_id%22%3A%22" + s542StylesID + "%22%2C%22pixel_ratio%22%3A3%2C%22is_push_on%22%3Afalse%2C%22debug_tooling_metadata_token%22%3Anull%2C%22is_flipper_enabled%22%3Afalse%2C%22theme_params%22%3A%5B%7B%22value%22%3A%5B%22three_neutral_gray%22%5D%2C%22design_system_name%22%3A%22XMDS%22%7D%2C%7B%22value%22%3A%5B%5D%2C%22design_system_name%22%3A%22FDS%22%7D%5D%2C%22bloks_version%22%3A%22" + s542BloksVer + "%22%7D%7D"
}
