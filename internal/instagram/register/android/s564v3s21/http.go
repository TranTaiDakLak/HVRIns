// http.go — S564V1S21 HTTP transport + request headers.
// Header format build .26 (port từ s562v3): bỏ appnetsession/tasos/qpl/network-props;
...
func newSession(proxyStr string) (*session, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("create S564V1S21 tls client: %w", err)
	}
...
// buildHeaders — S564V1S21 header format (port từ s562v3, build .26).
