...
type S560Profile struct {
	...
	S560UA                  string    // S564V1S21-specific User-Agent (FBAV 563, SM-G996B)
...
// buildS564V1S21UA — FB4A native UA cho SM-G996B (Galaxy S21+), version đọc từ versions_and_builds.txt.
