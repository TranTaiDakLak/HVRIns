// body.go — S485 register POST body builder + app constants.
// FBAV/485.0.0.70.77, FBBV/653066074.
...
var S560AppVersions = []struct {
	...
	{"485.0.0.70.77", "653066074"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "11994080424113465742885085542"
	S560BloksVer     = "19b565098d5e2b9fce6dd5409709828203b64572515f9c11343eac549b50dffc"
	...
	S560StylesID     = "cfe75e13b386d5c54b1de2dcca1bee5a"
	S560ZeroEH       = "664c0faaac849cb891d0a261fbb72a12"

	// OriginalUA — UA gốc cố định cho platform S560 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/485.0.0.70.77;FBBV/653066074;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
