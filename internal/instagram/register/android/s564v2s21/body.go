...
// FBAV/564.0.0.0.61, FBBV/980390555 — captured 2026-05 từ thiết bị Samsung Galaxy S21+ (SM-G996B).
...
var S560AppVersions = []struct {
	...
	{"564.0.0.0.61", "980390555"}, // captured 564v1 (S21+, 2026-05) — build .23.73
}

const (
	S560DocID        = "11994080423734609707368500843"
	...
	OriginalUA = "[FBAN/FB4A;FBAV/564.0.0.0.61;FBBV/980390555;FBDM/{density=2.8125,width=1080,height=2400};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G996B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
