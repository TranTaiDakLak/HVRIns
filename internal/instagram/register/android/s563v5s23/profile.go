...
type S560Profile struct {
	...
	S560UA                  string    // S563V4S21-specific User-Agent (FBAV 563, SM-S911B)
...
// buildS563V4S21UA — FB4A native UA cho SM-S911B (Galaxy S23+), version đọc từ versions_and_builds.txt.
func buildS563V4S21UA(device S23Device, locale, carrier string, addVirtualSpecs bool, r *rand.Rand) string {
	fbav, fbbv := "563.0.0.23.73", "980389559"
