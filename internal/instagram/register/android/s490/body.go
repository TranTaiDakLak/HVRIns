// body.go — S490 register POST body builder + app constants.
// FBAV/490.0.0.0.90, FBBV/668794794.
...
var S560AppVersions = []struct {
	...
	{"490.0.0.0.90", "668794794"}, // captured traffic — confirmed (May 2026)
}
...
const (
	...
	OriginalUA = "[FBAN/FB4A;FBAV/490.0.0.0.90;FBBV/668794794;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
