// body.go â€” S565 register POST body builder + app constants.
// FBAV/565.0.0.0.58, FBBV/986097483.
// KhÃ¡c s557: doc_id má»›i, bloks_ver má»›i, styles_id má»›i, is_push_on=false,
// theme_params=[XMDS+FDS], thÃªm aac="" vÃ o client_input_params.
package s565v2s21
...
// â”€â”€â”€ S565 app constants â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

var s565AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"565.0.0.0.58", "986097483"}, // captured traffic â€” confirmed (May 2026)
}

const (
	s565DocID        = "11994080428380165281378204618"
	s565BloksVer     = "8e49df647dadb22e676275e71f803c0045cccaf178e55a3033ee1e14eb0c816c"
	s565OAuthToken   = "350685531728|62f8ce9f74b12f84c123cc23437a4a32"
	s565MetaZCA      = "empty_token"
	s565FriendlyName = "FbBloksActionRootQuery-com.bloks.www.bloks.caa.reg.create.account.async"
	s565StylesID     = "0daae0d5b8cb6e6bd9943399b12bcd5b"

	// OriginalUA â€” UA gá»‘c cá»‘ Ä‘á»‹nh cho platform s565v2s21 (SM-G996B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/565.0.0.0.58;FBBV/986097483;FBDM/{density=2.8125,width=1080,height=2400};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G996B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung S21+ device variant (reused for s565)
...
var s23Devices = []S23Device{
	...
	{Model: "SM-G996N", Name: "Galaxy S21+ KR", Width: 1080, Height: 2400, Density: "2.8125", FBSS: "3"},
	{Model: "SM-G996U", Name: "Galaxy S21+ US", Width: 1080, Height: 2400, Density: "2.8125", FBSS: "3"},
	{Model: "SM-G996U1", Name: "Galaxy S21+ US Carrier", Width: 1080, Height: 2400, Density: "2.8125", FBSS: "3"},
	{Model: "SM-S916B", Name: "Galaxy S23+", Width: 1080, Height: 2400, Density: "2.8125", FBSS: "3"},
	{Model: "SM-S918B", Name: "Galaxy S23 Ultra", Width: 1440, Height: 3088, Density: "3.0", FBSS: "4"},
}

var s24Devices = []S23Device{
	{Model: "SM-S921B", Name: "Galaxy S24", Width: 1080, Height: 2400, Density: "2.8125", FBSS: "3"},
	{Model: "SM-S921U", Name: "Galaxy S24 US", Width: 1080, Height: 2400, Density: "2.8125", FBSS: "3"},
...
// DevicePoolForPlatform tráº£ vá» pool device theo platform.
func DevicePoolForPlatform(platform string) []S23Device {
	switch platform {
	case "s24":
		return s24Devices
	default: // "s565v2s21", "s23"
		return s23Devices
	}
}

// â”€â”€â”€ Escape primitives â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// buildRegisterBody sinh form-urlencoded body cho S565 reg.create.account.async.
func buildRegisterBody(profile S565S21Profile, encPassword, contactpoint, contactpointType, locale string) string {
	variables := createAccountVariablesS565(profile, encPassword, contactpoint, contactpointType)
	...
	parts := []string{
		...
		"locale=" + locale,
		"purpose=fetch",
		"fb_api_req_friendly_name=" + s565FriendlyName,
		"fb_api_caller_class=graphservice",
		"client_doc_id=" + s565DocID,
...
func createAccountVariablesS565(profile S565S21Profile, encPassword, contactpoint, contactpointType string) string {
	...
	// â”€â”€ 559 client_input_params thÃªm aac="" so vá»›i 557 â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	return "%7B%22params%22%3A%7B%22params%22%3A%22%7B%5C%22params%5C%22%3A%5C%22%7B" +
		...
		"%5C%22%7D%22%2C%22bloks_versioning_id%22%3A%22" + s565BloksVer + "%22%2C%22app_id%22%3A%22com.bloks.www.bloks.caa.reg.create.account.async%22%7D%2C%22scale%22%3A%223%22%2C%22nt_context%22%3A%7B%22using_white_navbar%22%3Atrue%2C%22styles_id%22%3A%22" + s565StylesID + "%22%2C%22pixel_ratio%22%3A3%2C%22is_push_on%22%3Afalse%2C%22debug_tooling_metadata_token%22%3Anull%2C%22is_flipper_enabled%22%3Afalse%2C%22theme_params%22%3A%5B%7B%22value%22%3A%5B%22three_neutral_gray%22%5D%2C%22design_system_name%22%3A%22XMDS%22%7D%2C%7B%22value%22%3A%5B%5D%2C%22design_system_name%22%3A%22FDS%22%7D%5D%2C%22bloks_version%22%3A%22" + s565BloksVer + "%22%7D%7D"
}
