// body.go — S555 register POST body builder + app constants.
// Sử dụng API Facebook v555 (FBAV/555.0.0.49.59, FBBV/926292570).
//
// S555 chỉ khác s557 ở app version pool và bloks_versioning_id/doc_id.
package s555
...
var s555AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"555.0.0.49.59", "926292570"}, // captured traffic — confirmed real (April 2026)
}

const (
	s555DocID        = "119940804217734265480409226803"
	s555BloksVer     = "d1583f026cccd22345fea8de656bb1d8162dabcca3249d6a0610be47545ec31a"
	s555OAuthToken   = "350685531728|62f8ce9f74b12f84c123cc23437a4a32"
	s555MetaZCA      = "empty_token"
	s555FriendlyName = "FbBloksActionRootQuery-com.bloks.www.bloks.caa.reg.create.account.async"

	// OriginalUA — UA gốc cố định cho platform s555 (SM-S911B, en_GB, Viettel).
	// Dùng khi "Dùng UA Gốc" được bật — không random, không Dalvik prefix.
	OriginalUA = "[FBAN/FB4A;FBAV/555.0.0.49.59;FBBV/926292570;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung S23 device variant (reused for s555)
...
// buildRegisterBody sinh form-urlencoded body cho S555 reg.password.async.
func buildRegisterBody(profile S555Profile, encPassword, contactpoint, contactpointType, locale string) string {
	variables := createAccountVariablesS555(profile, encPassword, contactpoint, contactpointType)
	...
	parts := []string{
		...
		"locale=" + locale,
		"purpose=fetch",
		"fb_api_req_friendly_name=" + s555FriendlyName,
		"fb_api_caller_class=graphservice",
		"client_doc_id=" + s555DocID,
...
func createAccountVariablesS555(profile S555Profile, encPassword, contactpoint, contactpointType string) string {
	...
	// ── 555 nt_context: theme_params=[XMDS+FDS], is_push_on=true ──────────────
	return "%7B%22params%22%3A%7B%22params%22%3A%22%7B%5C%22params%5C%22%3A%5C%22%7B" +
		...
		"%5C%22%7D%22%2C%22bloks_versioning_id%22%3A%22" + s555BloksVer + "%22%2C%22app_id%22%3A%22com.bloks.www.bloks.caa.reg.create.account.async%22%7D%2C%22scale%22%3A%223%22%2C%22nt_context%22%3A%7B%22using_white_navbar%22%3Atrue%2C%22styles_id%22%3A%226100e7e89411ccf67ace027cedecd84f%22%2C%22pixel_ratio%22%3A3%2C%22is_push_on%22%3Atrue%2C%22debug_tooling_metadata_token%22%3Anull%2C%22is_flipper_enabled%22%3Afalse%2C%22theme_params%22%3A%5B%7B%22value%22%3A%5B%22BLUEPRINT_TEST_GUTTER%22%5D%2C%22design_system_name%22%3A%22FDS%22%7D%5D%2C%22bloks_version%22%3A%22" + s555BloksVer + "%22%7D%7D"
}
