// body.go — S563V4S21 register POST body builder + app constants.
// FBAV/563.0.0.23.73, FBBV/978036554 — captured 2026-05 từ thiết bị Samsung Galaxy S21+ (SM-G996B).
// Khác s563v3s21: build .23.73 (cao hơn .0.48), doc_id mới hoàn toàn.
// theme XMDS+FDS, is_push_on=true. Clone từ register/s563v3s21 — swap FBAV/FBBV/DocID.
package s563v4s21
...
// ─── S563V4S21 app constants ─────────────────────────────────────────────────────

var S560AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"563.0.0.23.73", "978036554"}, // captured 563v4 (S21+, 2026-05) — build .23.73
}

const (
	S560DocID        = "11994080426742906638567181549"
	...
	// OriginalUA — UA gốc cố định cho platform S563V4S21 (SM-G996B Galaxy S21+, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/563.0.0.23.73;FBBV/978036554;FBDM/{density=2.8125,width=1080,height=2400};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G996B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung device variant (reused for S563V4S21 — Galaxy S21 family).
...
// buildRegisterBody sinh form-urlencoded body cho S563V4S21 reg.create.account.async.
