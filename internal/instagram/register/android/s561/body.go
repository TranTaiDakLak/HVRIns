// body.go — S561 register POST body builder + app constants.
// FBAV/561.0.0.3.67, FBBV/964730465.
// Captured May 2026: doc_id/bloks_ver/styles_id mới, is_push_on=true,
// theme_params=[XMDS three_neutral_gray + FDS empty], client_input_params.aac là JSON string.
package s561
...
var S560AppVersions = []struct {
	...
	{"561.0.0.3.67", "964730465"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "119940804210934765769791410287"
	...
	// OriginalUA — UA gốc cố định cho platform S561 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/561.0.0.3.67;FBBV/964730465;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
