// body.go — S473 register POST body builder + app constants.
// FBAV/473.0.0.0.73, FBBV/625301541.
...
var S560AppVersions = []struct {
	...
	{"473.0.0.0.73", "625301541"}, // captured traffic — confirmed (May 2026)
}
...
const (
	...
	OriginalUA = "[FBAN/FB4A;FBAV/473.0.0.0.73;FBBV/625301541;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
