// body.go — S425 register POST body builder + app constants.
// FBAV/425.0.0.22.49, FBBV/498189258.
...
var S560AppVersions = []struct {
	...
	{"425.0.0.22.49", "498189258"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "119940804215467192679525549522"
	S560BloksVer     = "4bec40073343147852635a8f492649cda5f794bc733bb5aa2012fd5509201c66"
	...
	S560StylesID     = "6bc57bcdb72a53b9c544ed3f33f57089"
	S560ZeroEH       = "664c0faaac849cb891d0a261fbb72a12"

	// OriginalUA — UA gốc cố định cho platform S560 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/425.0.0.22.49;FBBV/498189258;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
