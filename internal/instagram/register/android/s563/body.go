// body.go â€” S563 register POST body builder + app constants.
// FBAV/563.0.0.0.14, FBBV/972124634.
...
// â”€â”€â”€ S563 app constants â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

var s563AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"563.0.0.0.14", "972124634"}, // captured traffic â€” confirmed (May 2026)
}

const (
	s563DocID        = "1199408042594970992837994886"
	s563BloksVer     = "752772a2bf689dac5dc5fab7c56e888fe08e0569bef53cee7890974e5457ec75"
	s563OAuthToken   = "350685531728|62f8ce9f74b12f84c123cc23437a4a32"
	s563MetaZCA      = "empty_token"
	s563FriendlyName = "FbBloksActionRootQuery-com.bloks.www.bloks.caa.reg.create.account.async"
	s563StylesID     = "fefbd1d6b452bcac026b965ec70e37ee"

	// OriginalUA â€” UA gá»‘c cá»‘ Ä‘á»‹nh cho platform s563 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/563.0.0.0.14;FBBV/972124634;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung S23 device variant (reused for s563)
...
// buildRegisterBody sinh form-urlencoded body cho S563 reg.create.account.async.
func buildRegisterBody(profile S563Profile, encPassword, contactpoint, contactpointType, locale string) string {
	variables := createAccountVariablesS563(profile, encPassword, contactpoint, contactpointType)
	...
	parts := []string{
		...
		"locale=" + locale,
		"purpose=fetch",
		"fb_api_req_friendly_name=" + s563FriendlyName,
		"fb_api_caller_class=graphservice",
		"client_doc_id=" + s563DocID,
...
func createAccountVariablesS563(profile S563Profile, encPassword, contactpoint, contactpointType string) string {
	...
	return "%7B%22params%22%3A%7B%22params%22%3A%22%7B%5C%22params%5C%22%3A%5C%22%7B" +
		...
		"%5C%22%7D%22%2C%22bloks_versioning_id%22%3A%22" + s563BloksVer + "%22%2C%22app_id%22%3A%22com.bloks.www.bloks.caa.reg.create.account.async%22%7D%2C%22scale%22%3A%223%22%2C%22nt_context%22%3A%7B%22using_white_navbar%22%3Atrue%2C%22styles_id%22%3A%22" + s563StylesID + "%22%2C%22pixel_ratio%22%3A3%2C%22is_push_on%22%3Afalse%2C%22debug_tooling_metadata_token%22%3Anull%2C%22is_flipper_enabled%22%3Afalse%2C%22theme_params%22%3A%5B%7B%22value%22%3A%5B%22three_neutral_gray%22%5D%2C%22design_system_name%22%3A%22XMDS%22%7D%2C%7B%22value%22%3A%5B%5D%2C%22design_system_name%22%3A%22FDS%22%7D%5D%2C%22bloks_version%22%3A%22" + s563BloksVer + "%22%7D%7D"
}
