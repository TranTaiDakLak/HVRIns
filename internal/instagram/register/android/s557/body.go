// body.go — S557 register POST body builder + app constants.
// Sử dụng API Facebook v557 (FBAV/557.0.0.59.72, FBBV/942218792).
//
// Dùng chung doc_id + bloks_ver + create.account.async với S23 vì đây là
// bước cuối tạo tài khoản. S557 chỉ khác ở app version pool.
package s557
...
var s557AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"557.0.0.59.72", "942218792"}, // captured traffic — confirmed real (April 2026)
}

const (
	s557DocID        = "11994080422955588194694478490"
	s557BloksVer     = "385fe019aa6b5903bdad3a4799063e3fc70da9cd1fda8b54189bce078c701665"
	s557OAuthToken   = "350685531728|62f8ce9f74b12f84c123cc23437a4a32"
	s557MetaZCA      = "empty_token"
	s557FriendlyName = "FbBloksActionRootQuery-com.bloks.www.bloks.caa.reg.create.account.async"

	// OriginalUA — UA gốc cố định cho platform s557 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/557.0.0.59.72;FBBV/942218792;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung S23 device variant (reused for s557)
...
// buildRegisterBody sinh form-urlencoded body cho S557 reg.password.async.
func buildRegisterBody(profile S557Profile, encPassword, contactpoint, contactpointType, locale string) string {
	variables := createAccountVariablesS557(profile, encPassword, contactpoint, contactpointType)
	...
	parts := []string{
		...
		"locale=" + locale,
		"purpose=fetch",
		"fb_api_req_friendly_name=" + s557FriendlyName,
		"fb_api_caller_class=graphservice",
		"client_doc_id=" + s557DocID,
...
func createAccountVariablesS557(profile S557Profile, encPassword, contactpoint, contactpointType string) string {
	...
	// ── 557 nt_context: theme_params=[XMDS+FDS], is_push_on=false ──────────────
	return "%7B%22params%22%3A%7B%22params%22%3A%22%7B%5C%22params%5C%22%3A%5C%22%7B" +
		...
		"%5C%22%7D%22%2C%22bloks_versioning_id%22%3A%22" + s557BloksVer + "%22%2C%22app_id%22%3A%22com.bloks.www.bloks.caa.reg.create.account.async%22%7D%2C%22scale%22%3A%223%22%2C%22nt_context%22%3A%7B%22using_white_navbar%22%3Atrue%2C%22styles_id%22%3A%226100e7e89411ccf67ace027cedecd84f%22%2C%22pixel_ratio%22%3A3%2C%22is_push_on%22%3Atrue%2C%22debug_tooling_metadata_token%22%3Anull%2C%22is_flipper_enabled%22%3Afalse%2C%22theme_params%22%3A%5B%7B%22value%22%3A%5B%22BLUEPRINT_TEST_GUTTER%22%5D%2C%22design_system_name%22%3A%22FDS%22%7D%5D%2C%22bloks_version%22%3A%22" + s557BloksVer + "%22%7D%7D"
}
