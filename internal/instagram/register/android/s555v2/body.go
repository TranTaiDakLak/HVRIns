// body.go — S555V2 register POST body builder + app constants.
// FBAV/555.0.0.49.59, FBBV/926293010.
...
var S560AppVersions = []struct {
	...
	{"555.0.0.49.59", "926293010"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "119940804217734265480409226803"
	S560BloksVer     = "d1583f026cccd22345fea8de656bb1d8162dabcca3249d6a0610be47545ec31a"
	...
	OriginalUA = "[FBAN/FB4A;FBAV/555.0.0.49.59;FBBV/926293010;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
