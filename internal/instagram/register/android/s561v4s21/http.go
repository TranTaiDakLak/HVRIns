// http.go — S561V4S21 HTTP transport + request headers.
...
func newSession(proxyStr string) (*session, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("create S561V4S21 tls client: %w", err)
	}
...
// buildHeaders — S561V4S21 header format (captured 561v2, build 561.0.0.42.67).
