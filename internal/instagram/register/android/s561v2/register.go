// package s561v2 — Samsung Galaxy S23 + Facebook API 561 v2 registration.
...
func init() {
	instagram.RegisterPlatformRegisterer(instagram.PlatformS561V2, func() instagram.Registerer {
		return &Registerer{}
	})
}
