// body.go — S491 register POST body builder + app constants.
// FBAV/491.0.0.0.91, FBBV/671940539.
...
var S560AppVersions = []struct {
	...
	{"491.0.0.0.91", "671940539"}, // captured traffic — confirmed (May 2026)
}
...
const (
	...
	OriginalUA = "[FBAN/FB4A;FBAV/491.0.0.0.91;FBBV/671940539;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
