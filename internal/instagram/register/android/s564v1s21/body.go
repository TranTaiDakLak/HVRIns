// body.go — S564V1S21 register POST body builder + app constants.
// FBAV/564.0.0.0.17, FBBV/977893103 — captured 2026-05 từ thiết bị Samsung Galaxy S21+ (SM-G996B).
...
// ─── S564V1S21 app constants ─────────────────────────────────────────────────────

var S560AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"564.0.0.0.17", "977893103"}, // captured 564v1 (S21+, 2026-05) — build .23.73
}

const (
	S560DocID        = "11994080428908932823877210452"
	S560BloksVer     = "c36891378e117e5eaef5b658a382d93c08b183fa9495d1facec29fbb62a81f8a"
	...
	S560StylesID     = "998f39d919f970c8b482d16e00c743a4"
	S560ZeroEH       = "664c0faaac849cb891d0a261fbb72a12"

	// OriginalUA — UA gốc cố định cho platform S564V1S21 (SM-G996B Galaxy S21+, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/564.0.0.0.17;FBBV/977893103;FBDM/{density=2.8125,width=1080,height=2400};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G996B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung device variant (reused for S564V1S21 — Galaxy S21 family).
...
// buildRegisterBody sinh form-urlencoded body cho S564V1S21 reg.create.account.async.
