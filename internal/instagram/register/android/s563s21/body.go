// body.go — S563S21 register POST body builder + app constants.
// FBAV/563.0.0.0.26, FBBV/972941018 — captured từ RegS21 (Samsung Galaxy S21+ SM-G996B).
// Giống s562v3/s563v2 build .26 (doc_id/bloks_ver/styles_id), is_push_on=true,
// theme_params=FDS-only, client_input_params.aac là JSON string.
// Khác s562v3: device profile = SM-G996B (Galaxy S21+), density 2.8125, 1080x2400.
package s563s21
...
// ─── S563S21 app constants ─────────────────────────────────────────────────────

var S560AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"563.0.0.0.26", "972941018"}, // captured RegS21 traffic — confirmed (May 2026)
}

const (
	S560DocID        = "119940804212271057732132442903"
	...
	// OriginalUA — UA gốc cố định cho platform S563S21 (SM-G996B Galaxy S21+, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/563.0.0.0.26;FBBV/972941018;FBDM/{density=2.8125,width=1080,height=2400};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G996B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung device variant (reused for S563S21 — Galaxy S21 family).
...
// buildRegisterBody sinh form-urlencoded body cho S563S21 reg.create.account.async.
