// profile.go — S560 device profile + UA builder + cookie seed + shared pool.
package s560
...
func BuildProfileForPlatformWithUA(platform, countryCode string, addVirtualSpecs bool) S560Profile {
	...
	// trộn FBAV 300→559+ → có thể trúng version cũ). Hardcode đảm bảo s560 luôn ra
	// FBAV/560.0.0.26.63 bất kể có file Config riêng hay không.
