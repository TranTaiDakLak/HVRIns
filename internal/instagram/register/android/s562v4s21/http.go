// http.go — S562V4S21 HTTP transport + request headers.
// Header format port từ s563s21 (captured 561v2 2026-05, S21+ device).
// Headers giống s561v3/s562: bỏ appnetsession/tasos/qpl/network-props;
...
func newSession(proxyStr string) (*session, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("create S562V4S21 tls client: %w", err)
	}
...
// buildHeaders — S562V4S21 header format (captured 561v2, build 561.0.0.42.67).
