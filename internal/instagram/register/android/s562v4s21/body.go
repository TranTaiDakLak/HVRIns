// body.go — S562V4S21 register POST body builder + app constants.
// FBAV/562.0.0.51.73, FBBV/976057955 — captured 2026-05 từ thiết bị Samsung Galaxy S21+ (SM-G996B).
// Doc_id/bloks_ver mới (562v4 capture), theme XMDS+FDS, device S21+.
// Clone từ register/s561v4s21 — chỉ swap constants (FBAV/FBBV/DocID/BloksVer).
package s562v4s21
...
// ─── S562V4S21 app constants ──────────────────────────────────────────────────

var S560AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"562.0.0.51.73", "976057955"}, // captured 562v4 (S21+, 2026-05) — confirmed
}

const (
	S560DocID        = "119940804212653772530264493669"
	S560BloksVer     = "ea49f1cd6ce051bc2f45bf5e30780f144df6e9a7e2fe3bbf011a1b0c68a90344"
	...
	// OriginalUA — UA gốc cố định cho platform S562V4S21 (SM-G996B Galaxy S21+, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/562.0.0.51.73;FBBV/976057955;FBDM/{density=2.8125,width=1080,height=2400};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G996B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
