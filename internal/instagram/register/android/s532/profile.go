...
// s532Profile holds all s532-specific data for one registration session.
type s532Profile struct {
...
// BuildProfileForPlatform builds a complete s532 registration profile (default UA).
func BuildProfileForPlatform(platform, countryCode string) s532Profile {
...
func BuildProfileForPlatformWithUA(platform, countryCode string, addVirtualSpecs bool) s532Profile {
	...
	// FBAV/532.0.0.44.92 bất kể có file Config riêng hay không.
