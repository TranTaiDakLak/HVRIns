// body.go — S455 register POST body builder + app constants.
// FBAV/455.0.0.44.88, FBBV/578199800.
...
var S560AppVersions = []struct {
	...
	{"455.0.0.44.88", "578199800"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "11994080422911873693149755833"
	S560BloksVer     = "646a342968698e749c600b41a0e530e4386d17fae2cf4aa21cf3ca7b47c3771d"
	...
	S560StylesID     = "70bb6d055a5c768824a62f7bceb7e759"
	S560ZeroEH       = "664c0faaac849cb891d0a261fbb72a12"

	// OriginalUA — UA gốc cố định cho platform S560 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/455.0.0.44.88;FBBV/578199800;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
