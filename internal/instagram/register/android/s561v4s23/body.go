// body.go — S561V4S23 register POST body builder + app constants.
// FBAV/561.0.0.42.67, FBBV/976056141 — captured 2026-05 từ thiết bị Samsung Galaxy S23 (SM-S911B).
// Cùng doc_id/bloks_ver như s561v4s21 (capture 561v2 mới) nhưng device pool S23 (density 3.0, 1080x2340).
// Theme XMDS+FDS, is_push_on=true (giống capture 561v2).
// Clone từ register/s562 — chỉ swap constants + theme.
package s561v4s23
...
// ─── S561V4S23 app constants (capture 561v2 mới, 2026-05) ──────────────────────

var S560AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"561.0.0.42.67", "976056141"}, // captured 561v2 mới (S21+ — copy sang S23 device)
}
...
const (
	...
	// OriginalUA — UA gốc cố định cho platform S561V4S23 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/561.0.0.42.67;FBBV/976056141;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung S23 device variant (reused for S560)
...
// buildRegisterBody sinh form-urlencoded body cho S560 reg.create.account.async.
...
func createAccountVariablesS560(profile S560Profile, encPassword, contactpoint, contactpointType string) string {
	...
	// ── 559 client_input_params thêm aac="" so với 557 ──────────────────────────
