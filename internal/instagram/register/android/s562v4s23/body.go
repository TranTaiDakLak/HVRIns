// body.go — S562V4S23 register POST body builder + app constants.
// FBAV/562.0.0.51.73, FBBV/976057955 — capture 562v4 (S21+) — copy sang device S23 (SM-S911B).
// Cùng doc_id/bloks_ver như s562v4s21 nhưng device pool S23 (density 3.0, 1080x2340).
// Theme XMDS+FDS, is_push_on=true. Clone từ register/s561v4s23 — chỉ swap constants.
package s562v4s23
...
// ─── S562V4S23 app constants (capture 562v4 mới, 2026-05) ────────────────────

var S560AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"562.0.0.51.73", "976057955"}, // captured 562v4 (S21+ — copy sang S23 device)
}
...
const (
	...
	// OriginalUA — UA gốc cố định cho platform S562V4S23 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/562.0.0.51.73;FBBV/976057955;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
