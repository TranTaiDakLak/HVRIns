// body.go — S558V2 register POST body builder + app constants.
// FBAV/558.0.0.70.72, FBBV/959738023.
...
var S560AppVersions = []struct {
	...
	{"558.0.0.70.72", "959738023"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "119940804212218769903962986547"
	S560BloksVer     = "675d0e80077ec27b1248cdcfb41273ddb3e589b7aa4b2a45f6c013a5b682486b"
	...
	S560StylesID     = "6100e7e89411ccf67ace027cedecd84f"
	S560ZeroEH       = "664c0faaac849cb891d0a261fbb72a12"

	// OriginalUA — UA gốc cố định cho platform S560 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/558.0.0.70.72;FBBV/959738023;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
