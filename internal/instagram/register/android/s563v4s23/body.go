// body.go — S563V4S23 register POST body builder + app constants.
// FBAV/563.0.0.23.73, FBBV/978036554 — captured 2026-05 từ thiết bị Samsung Galaxy S23 (SM-S911B).
...
// ─── S563V4S23 app constants ─────────────────────────────────────────────────────

var S560AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"563.0.0.23.73", "978036554"}, // captured 563v4 (S23, 2026-05) — build .23.73
}
...
const (
	...
	// OriginalUA — UA gốc cố định cho platform S563V4S23 (SM-S911B Galaxy S23, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/563.0.0.23.73;FBBV/978036554;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung device variant (reused for S563V4S23 — Galaxy S23 family).
...
// s23Devices — Galaxy S23 family (SM-S91xB). Density 3.0, 1080x2340 (FBSS=3).
var s23Devices = []S23Device{
	{Model: "SM-S911B", Name: "Galaxy S23 5G", Width: 1080, Height: 2340, Density: "3.0", FBSS: "3"},
	{Model: "SM-S916B", Name: "Galaxy S23+ 5G", Width: 1080, Height: 2340, Density: "3.0", FBSS: "3"},
...
// buildRegisterBody sinh form-urlencoded body cho S563V4S23 reg.create.account.async.
