// body.go — S560 register POST body builder + app constants.
...
var S560AppVersions = []struct {
	...
	{"560.0.0.26.63", "959741200"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "119940804210382635615484396344"
	S560BloksVer     = "182a4e03087cc46a88a95c6e5747a622a0ab08e2134522bd0e6da65b9ceea9fd"
	...
	S560StylesID     = "fefbd1d6b452bcac026b965ec70e37ee"
	S560ZeroEH       = "664c0faaac849cb891d0a261fbb72a12"

	// OriginalUA — UA gốc cố định cho platform S560 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/560.0.0.26.63;FBBV/959741200;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
