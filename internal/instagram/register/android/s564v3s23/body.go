...
// FBAV/564.0.0.48.74, FBBV/986612294 — captured 2026-05 từ thiết bị Samsung Galaxy S23+ (SM-S911B).
...
const (
	...
	// OriginalUA — UA gốc cố định cho platform S564V1S21 (SM-S911B Galaxy S23+, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/564.0.0.48.74;FBBV/986612294;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung device variant (reused for S564V1S21 — Galaxy S23 family).
...
// s23Devices — Galaxy S23 family (SM-G99xB). Density 3.0, 1080x2400 (FBSS=3).
