// body.go — S435 register POST body builder + app constants.
// FBAV/435.0.0.42.112, FBBV/523162189.
...
var S560AppVersions = []struct {
	...
	{"435.0.0.42.112", "523162189"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "11994080428003704954252325796"
	S560BloksVer     = "81beec0074667d3bccd1808eb9072789f784db11770b14ef5aa9a756e810ebe5"
	...
	S560StylesID     = "1610d0f6c47062027525f7606f43033e"
	S560ZeroEH       = "664c0faaac849cb891d0a261fbb72a12"

	// OriginalUA — UA gốc cố định cho platform S560 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/435.0.0.42.112;FBBV/523162189;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
