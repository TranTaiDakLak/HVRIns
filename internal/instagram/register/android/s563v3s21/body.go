// body.go — S563V3S21 register POST body builder + app constants.
// FBAV/563.0.0.0.48, FBBV/974373688 — captured 2026-05 từ thiết bị Samsung Galaxy S21+ (SM-G996B).
// Khác s563s21: build .48 (cao hơn .26), doc_id mới hoàn toàn — bloks_versioning_id giữ nguyên.
// theme XMDS+FDS, is_push_on=true. Clone từ register/s563s21 — swap FBAV/FBBV/DocID.
package s563v3s21
...
// ─── S563V3S21 app constants ─────────────────────────────────────────────────────

var S560AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"563.0.0.0.48", "974373688"}, // captured 563v3 (S21+, 2026-05) — build .48 mới hơn s563s21 (.26)
}

const (
	S560DocID        = "11994080422283368733301219073"
	S560BloksVer     = "aa4e5e759b2f90492ba1b311dc98988f125b76705083a7e8b3fa11a3262f7459"
	...
	// OriginalUA — UA gốc cố định cho platform S563V3S21 (SM-G996B Galaxy S21+, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/563.0.0.0.48;FBBV/974373688;FBDM/{density=2.8125,width=1080,height=2400};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G996B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung device variant (reused for S563V3S21 — Galaxy S21 family).
...
// buildRegisterBody sinh form-urlencoded body cho S563V3S21 reg.create.account.async.
...
func createAccountVariablesS560(profile S560Profile, encPassword, contactpoint, contactpointType string) string {
	...
	// ── client_input_params có aac="" (build .26) ──────────────────────────────
