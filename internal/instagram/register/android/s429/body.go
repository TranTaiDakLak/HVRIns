// body.go — S429 register POST body builder + app constants.
// FBAV/429.0.0.0.29, FBBV/508178430.
...
var S560AppVersions = []struct {
	...
	{"429.0.0.0.29", "508178430"}, // captured traffic — confirmed (May 2026)
}
...
const (
	...
	OriginalUA = "[FBAN/FB4A;FBAV/429.0.0.0.29;FBBV/508178430;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
