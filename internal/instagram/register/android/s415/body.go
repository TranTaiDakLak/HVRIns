// body.go — S415 register POST body builder + app constants.
// FBAV/415.0.0.34.107, FBBV/475722615.
...
var S560AppVersions = []struct {
	...
	{"415.0.0.34.107", "475722615"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "11994080429355460875507864846"
	S560BloksVer     = "bd8701d8d9ba91295f01e2b6aef0ee8ab6184dc25dd3b46af83702f27c3079b7"
	...
	S560StylesID     = "e571066e6975c247f3440a033df4b7c0"
	S560ZeroEH       = "664c0faaac849cb891d0a261fbb72a12"

	// OriginalUA — UA gốc cố định cho platform S560 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/415.0.0.34.107;FBBV/475722615;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
