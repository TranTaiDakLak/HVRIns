// body.go — S561v2 register POST body builder + app constants.
// FBAV/561.0.0.42.67, FBBV/968460367.
// Captured May 2026: doc_id mới so với s561, bloks_ver/styles_id giữ nguyên.
package s561v3
...
// ─── S561V2 app constants ─────────────────────────────────────────────────────

var S560AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"561.0.0.42.67", "968460367"}, // captured traffic — confirmed (May 2026)
}
...
const (
	...
	// OriginalUA — UA gốc cố định cho platform S561V2 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/561.0.0.42.67;FBBV/968460367;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung S23 device variant (reused for S561V2)
...
// buildRegisterBody sinh form-urlencoded body cho S561V2 reg.create.account.async.
