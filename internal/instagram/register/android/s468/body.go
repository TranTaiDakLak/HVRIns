// body.go — S468 register POST body builder + app constants.
// FBAV/468.0.0.0.68, FBBV/612910184.
...
var S560AppVersions = []struct {
	...
	{"468.0.0.0.68", "612910184"}, // captured traffic — confirmed (May 2026)
}
...
const (
	...
	OriginalUA = "[FBAN/FB4A;FBAV/468.0.0.0.68;FBBV/612910184;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
