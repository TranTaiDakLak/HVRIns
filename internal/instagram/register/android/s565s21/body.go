...
// FBAV/565.0.0.0.28, FBBV/984080529.
...
var s565AppVersions = []struct {
	...
	{"565.0.0.0.28", "984080529"}, // captured traffic â€” confirmed (May 2026)
}

const (
	s565DocID        = "1199408042594970992837994886"
	s565BloksVer     = "752772a2bf689dac5dc5fab7c56e888fe08e0569bef53cee7890974e5457ec75"
	...
	s565StylesID     = "fefbd1d6b452bcac026b965ec70e37ee"

	// OriginalUA â€” UA gá»‘c cá»‘ Ä‘á»‹nh cho platform s565s21 (SM-G996B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/565.0.0.0.28;FBBV/984080529;FBDM/{density=2.8125,width=1080,height=2400};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G996B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
