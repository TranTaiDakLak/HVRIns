// body.go — S495 register POST body builder + app constants.
// FBAV/495.0.0.45.201, FBBV/684523515.
...
var S560AppVersions = []struct {
	...
	{"495.0.0.45.201", "684523515"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "119940804214699205634646038044"
	S560BloksVer     = "b18b0b2fb81505d18bb1271445ff7aec0e530099c63240ed8b198dd54419680c"
	...
	S560StylesID     = "75a7c78b2482b85a8e854653c8b7ec0a"
	S560ZeroEH       = "664c0faaac849cb891d0a261fbb72a12"

	// OriginalUA — UA gốc cố định cho platform S560 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/495.0.0.45.201;FBBV/684523515;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
