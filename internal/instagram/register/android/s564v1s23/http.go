// http.go — S564V1S23 HTTP transport + request headers.
...
func newSession(proxyStr string) (*session, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("create S564V1S23 tls client: %w", err)
	}
...
// buildHeaders — S564V1S23 header format (port từ s562v3, build .26).
