// body.go — S564V1S23 register POST body builder + app constants.
// FBAV/564.0.0.0.17, FBBV/977893103 — captured 2026-05 từ thiết bị Samsung Galaxy S23 (SM-S911B).
...
// ─── S564V1S23 app constants ─────────────────────────────────────────────────────

var S560AppVersions = []struct {
	Version string // FBAV
	Build   string // FBBV
}{
	{"564.0.0.0.17", "977893103"}, // captured 564v1 (S23, 2026-05) — build .23.73
}
...
const (
	...
	// OriginalUA — UA gốc cố định cho platform S564V1S23 (SM-S911B Galaxy S23, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/564.0.0.0.17;FBBV/977893103;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)

// S23Device represents a Samsung device variant (reused for S564V1S23 — Galaxy S23 family).
...
// buildRegisterBody sinh form-urlencoded body cho S564V1S23 reg.create.account.async.
