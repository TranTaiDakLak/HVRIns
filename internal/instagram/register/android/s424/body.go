// body.go — S424 register POST body builder + app constants.
// FBAV/424.0.0.0.24, FBBV/495942594.
...
var S560AppVersions = []struct {
	...
	{"424.0.0.0.24", "495942594"}, // captured traffic — confirmed (May 2026)
}
...
const (
	...
	OriginalUA = "[FBAN/FB4A;FBAV/424.0.0.0.24;FBBV/495942594;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
