// body.go — S445 register POST body builder + app constants.
// FBAV/445.0.0.34.118, FBBV/548452792.
...
var S560AppVersions = []struct {
	...
	{"445.0.0.34.118", "548452792"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "1199408042870689966045625207"
	S560BloksVer     = "2b781981a7f5aea22e309c8680b628b545bea6f0afa2b930a5ed772754ff06dc"
	...
	S560StylesID     = "93946ea073f962d7fb7bc17686943a4d"
	S560ZeroEH       = "664c0faaac849cb891d0a261fbb72a12"

	// OriginalUA — UA gốc cố định cho platform S560 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/445.0.0.34.118;FBBV/548452792;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
