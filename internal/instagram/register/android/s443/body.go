// body.go — S443 register POST body builder + app constants.
// FBAV/443.0.0.0.43, FBBV/543394671.
...
var S560AppVersions = []struct {
	...
	{"443.0.0.0.43", "543394671"}, // captured traffic — confirmed (May 2026)
}
...
const (
	...
	OriginalUA = "[FBAN/FB4A;FBAV/443.0.0.0.43;FBBV/543394671;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
