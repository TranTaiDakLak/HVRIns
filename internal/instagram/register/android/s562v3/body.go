// body.go — S562 register POST body builder + app constants.
// FBAV/562.0.0.0.28, FBBV/966787663.
...
var S560AppVersions = []struct {
	...
	{"562.0.0.0.28", "966787663"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "11994080424975422817712143844"
	S560BloksVer     = "e126032a6d9f10c51b99f542ebc351837d5f039af73ce199a40b86acf10a010b"
	...
	// OriginalUA — UA gốc cố định cho platform S562 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/562.0.0.0.28;FBBV/966787663;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
