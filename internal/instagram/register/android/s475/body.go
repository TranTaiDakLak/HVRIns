// body.go — S475 register POST body builder + app constants.
// FBAV/475.1.0.46.82, FBBV/630258084.
...
var S560AppVersions = []struct {
	...
	{"475.1.0.46.82", "630258084"}, // captured traffic — confirmed (May 2026)
}

const (
	S560DocID        = "119940804212287135538319254199"
	S560BloksVer     = "c932382c1788bc6179a64e0f799ea582acf0c4a5590273d613de80e2fcdf9f86"
	...
	S560StylesID     = "e6379af92cc321b29062427d665408ac"
	S560ZeroEH       = "664c0faaac849cb891d0a261fbb72a12"

	// OriginalUA — UA gốc cố định cho platform S560 (SM-S911B, en_GB, Viettel).
	OriginalUA = "[FBAN/FB4A;FBAV/475.1.0.46.82;FBBV/630258084;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S911B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
