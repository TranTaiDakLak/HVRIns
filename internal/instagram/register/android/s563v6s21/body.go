...
// FBAV/563.1.0.50.73, FBBV/986611012 — captured 2026-05 từ thiết bị Samsung Galaxy S21+ (SM-G996B).
...
var S560AppVersions = []struct {
	...
	{"563.1.0.50.73", "986611012"}, // captured 563v4 (S21+, 2026-05) — build .23.73
}

const (
	S560DocID        = "11994080426554467581667453023"
	...
	OriginalUA = "[FBAN/FB4A;FBAV/563.1.0.50.73;FBBV/986611012;FBDM/{density=2.8125,width=1080,height=2400};FBLC/en_GB;FBRV/0;FBCR/Viettel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G996B;FBSV/15;FBOP/1;FBCA/arm64-v8a:;]"
)
