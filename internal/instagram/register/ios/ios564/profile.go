// profile.go — iOS564 IOSProfile builder + UA builder + random helpers.
...
const (
	...
	docIDAction       = "37580109609106921721904672240"
	bloksVersioningID = "ef89eb5fbecdcbc7ddfaa0804847e4508af71e1558ff3a5e7f4dd6f6efb490f5"
	stylesID          = "35bb60d9f4297087b748b80b372c84a8"
...
func BuildProfileFromDevice(locale, countryCode string, dp DeviceProfile) IOSProfile {
	...
	return IOSProfile{
		...
		Locale:         locale,
		ConnType:       "wifi.CTRadioAccessTechnologyLTE", // TEST: ép wifi.* theo capture (revert: fakeinfo.RandomIOSConnType())
